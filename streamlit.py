...
from chatbot import extract_pdf, text_splitter, embedding, embedding_openai, run_chain, run_chain_openai
...
with st.sidebar:
    ...
    language = st.selectbox('language', options= ['English','Marathi', 'Hindi', 'Gujarati'])
